...
from authing.v2.management import users
...
class AuthenticationClient(object):
    ...
    def __init__(self, options: AuthenticationClientOptions):
        ...
        # 从 accessToken 中获取当前用户
        if self.options.access_token:
            self.get_current_user(token=self.options.access_token)
    ...
    def reset_password_with_phone_code(self):
        pass

    def reset_password_with_email_code(self):
        pass
